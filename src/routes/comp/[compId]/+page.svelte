...
<CompPageHeader compRecord={data.compRecord} surveyRecords={data.surveyRecords} page="overview" />
...
{#snippet transferWidget()}
  <div class="flex flex-col gap-2" style="view-transition-name:transfer">
    <div class="flex flex-col">
      <h2 class="font-bold">Bulk Transfer</h2>
      <span class="text-xs font-light">Scouting data and configs</span>
    </div>
