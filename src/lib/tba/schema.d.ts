...
export interface paths {
    ...
    "/insights/{year}": {
        ...
        get: operations["getInsightsV2Year"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/insights/{year}/{category}": {
        ...
        /** @description Gets a list of `InsightV2` objects for the given year filtered by category. Use year=0 for all-time insights. Returns only global (non-district-scoped) insights. Valid categories: leaderboard, streak, timeseries. */
        get: operations["getInsightsV2YearCategory"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/insights/{year}/district/{district_abbreviation}": {
        ...
        get: operations["getInsightsV2YearDistrict"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/insights/{year}/{category}/district/{district_abbreviation}": {
        ...
        /** @description Gets a list of `InsightV2` objects for the given year, category, and district. Use year=0 for all-time insights. Valid categories: leaderboard, streak, timeseries. */
        get: operations["getInsightsV2YearCategoryDistrict"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** @description A typed insight object. Use `category` to discriminate between leaderboard, streak, and timeseries shapes. */
        InsightV2: components["schemas"]["InsightV2_Leaderboard"] | components["schemas"]["InsightV2_Streak"] | components["schemas"]["InsightV2_Timeseries"];
        InsightV2_Base: {
        ...
        InsightV2_Leaderboard: components["schemas"]["InsightV2_Base"] & components["schemas"]["InsightV2_Leaderboard_Extras"] & {
            /**
             * @description discriminator enum property added by openapi-typescript
             * @enum {string}
             */
        ...
        InsightV2_Leaderboard_Extras: {
            /** @constant */
            category?: "leaderboard";
            data: components["schemas"]["InsightV2LeaderboardData"];
        };
        InsightV2_Streak: components["schemas"]["InsightV2_Base"] & components["schemas"]["InsightV2_Streak_Extras"] & {
            /**
             * @description discriminator enum property added by openapi-typescript
             * @enum {string}
             */
        ...
        InsightV2_Streak_Extras: {
            /** @constant */
            category?: "streak";
            data: components["schemas"]["InsightV2StreakData"];
        };
        InsightV2_Timeseries: components["schemas"]["InsightV2_Base"] & components["schemas"]["InsightV2_Timeseries_Extras"] & {
            /**
             * @description discriminator enum property added by openapi-typescript
             * @enum {string}
             */
        ...
        InsightV2_Timeseries_Extras: {
            /** @constant */
            category?: "timeseries";
            data: components["schemas"]["InsightV2TimeseriesData"];
        };
        ...
        InsightV2TimeseriesData: {
            /**
             * @description What the x-axis represents.
             * @enum {string}
             */
            ...
            series: {
                ...
                label: string;
                points: {
                    /** @description X-axis value (week string, year integer, or event key). */
                    x: string | number;
    ...
    parameters: {
        ...
        team_key: string;
        /** @description InsightV2 category. One of: leaderboard, streak, timeseries. */
        insight_v2_category: "leaderboard" | "streak" | "timeseries";
    ...
    getInsightsV2Year: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["InsightV2"][];
                };
            };
            304: components["responses"]["NotModified"];
            401: components["responses"]["Unauthorized"];
    ...
    getInsightsV2YearCategory: {
        parameters: {
            ...
            path: {
                ...
                year: components["parameters"]["year"];
                /** @description InsightV2 category. One of: leaderboard, streak, timeseries. */
                category: components["parameters"]["insight_v2_category"];
            };
            cookie?: never;
        };
        requestBody?: never;
